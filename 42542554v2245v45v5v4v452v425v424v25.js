...
const APP = {
    ...
    theme: {
        name: "EclipseLunar",
        logo: "https://crimsonstrauss.xyz/img/logo/eclipse.png",
        colors: {
        ...
        credits: "Made by [@Crimsonstrauss]",
        discordUrl: "https://discord.gg/H6V7RWzKgV"
    },
...
async function initApp() {
    try {
        ...
        sendToast(`☪️ Crimson v${APP.version} loaded!`, 2000);
    } catch (error) {
        console.error("Erro ao inicializar ☪️ Crimson:", error);
        sendToast("⚠️ Erro ao inicializar ☪️ Crimson", 3000);
    }
}
