...
class Core {
    ...
    static async setupAuto() {
        ...
        const buttonSelectors = [
            '[data-testid="exercise-check-answer-button"]',
            'button[type="submit"]',
            'button:contains("Verificar")',
            'button:contains("Próximo")',
            'button:contains("Continuar")',
            'button:contains("Mostrar resumo")'
        ];
        ...
        function findAndClickButton() {
            for (const selector of buttonSelectors) {
                ...
                if (button && !button.disabled && button.offsetParent !== null) {
                    button.click();
                    if (button.textContent.includes("Mostrar resumo") || button.textContent.includes("resumo")) {
            ...
            for (const className of nextButtonClasses) {
        ...
        console.log("🤖 Auto Complete iniciado");
        while (true) {
            try {
                await autoComplete();
                await delay(APP.cfg.speed);
